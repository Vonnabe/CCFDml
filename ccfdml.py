...
Original file is located at
    https://colab.research.google.com/drive/1Sq4BHJFl0Ie0g9Glc9WUsCnij34mmjxy
"""
...
train, test, val = new_df[:24000], new_df[24000:26200], new_df[26200:]
...
print(classification_report(y_val, logistic_model.predict(x_val), target_names=['Not Fraud', "Fraid"]))
...
balanced_df = pd.concat([fraud, not_fraud.sample(len(fraud), random_state=1)])
...
shallow_nn_b1.fit(x_train_b, y_train_b, validation_data=(x_val_b, y_val_b), epochs=30, callbacks=checkpoint)
...
print(classification_report(y_test_b, neural_net_prediction(shallow_nn_b, x_test_b), target_names=['Not Fraud', 'Fraud']))